...
class pdf_jornadas extends FPDF{
	   ...
	   public function header(){
		...
		$this -> cell(180,45,"Jornadas",0,0,'C');
	...
	$this -> cell(60,10,"Jornada Mañana",0,0,'C','true');
	$this -> cell(60,10,"Jornada Tarde",0,0,'C','true');
	$this -> cell(60,10,"Programa",0,0,'C','true');
	$this-> SetDrawColor(51, 181, 255);
	$this-> SetLineWidth(1);
	...
	$this -> Ln(2);
	   ...
	   public function Cuerpo_Tabla($pdo){
		...
		$this->SetDrawColor(16, 15, 15);
	   	$stm = $pdo -> Query("SELECT * FROM jornada");
	   	while ($data = $stm -> fetch(PDO::FETCH_OBJ))
	   	{
			$this -> Ln(10);
			$this -> cell(60,10,$data->jornada_M,1,0,'L');
			$this -> cell(60,10,$data->jornada_T,1,0,'L');
			$this -> cell(60,10,$data->Codigo_programa,1,0,'L');
