...
class pdf_novedades extends FPDF{
	   ...
	   public function header(){
		...
		$this -> cell(180,45,"Novedades",0,0,'C');
	...
	$this -> cell(45,10,"Reserva",0,0,'C','true');
	$this -> cell(45,10,"Tipo",0,0,'C','true');
	$this -> cell(45,10,"Fecha",0,0,'C','true');
	$this -> cell(45,10,"Nombre",0,0,'C','true');
	$this-> SetDrawColor(51, 181, 255);
	$this-> SetLineWidth(1);
	...
	$this -> Ln(2);
	   ...
	   public function Cuerpo_Tabla($pdo){
		...
		$this->SetDrawColor(16, 15, 15);
	   	$stm = $pdo -> Query("SELECT * FROM novedad");
	   	while ($data = $stm -> fetch(PDO::FETCH_OBJ))
	   	{
			$this -> Ln(10);
			$this -> cell(45,10,$data->Id_reserva,1,0,'C');
			$this -> cell(45,10,$data->Id_tipo,1,0,'C');
			$this -> cell(45,10,$data->fecha,1,0,'C');
			$this -> cell(45,10,$data->NombreNovedad,1,0,'C');	
	   }
	}
	function Footer()
	{
