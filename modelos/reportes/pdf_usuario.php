...
class pdf_usuario extends FPDF{
	   ...
	   public function header(){
		...
		$this -> cell(180,45,"Usuarios",0,0,'C');
	...
	$this -> cell(60,10,"Correo electronico",0,0,'C','true');
	$this -> cell(20,10,"Nombres",0,0,'C','true');
	$this -> cell(25,10,"Apellidos",0,0,'C','true');
	$this -> cell(38,10,"Documento",0,0,'C','true');
	$this -> cell(23,10,"Telefono",0,0,'C','true');
	$this -> cell(25,10,"Celular",0,0,'C','true');
	$this-> SetDrawColor(51, 181, 255);
	$this-> SetLineWidth(1);
	...
	$this -> Ln(2);
	   ...
	   public function Cuerpo_Tabla($pdo){
		...
		$this->SetDrawColor(16, 15, 15);
	   	...
	   	{
			$this -> Ln(10);
			$this -> cell(60,10,$data->Correo_usuario,1,0,'L');
			$this -> cell(20,10,$data->Nombres,1,0,'L');
			$this -> cell(25,10,$data->Apellidos,1,0,'L');
			$this -> cell(38,10,$data->Numero_documento,1,0,'L');
			$this -> cell(23,10,$data->Telefono,1,0,'L');
	   		$this -> cell(25,10,$data->Tel_celular,1,0,'L');
